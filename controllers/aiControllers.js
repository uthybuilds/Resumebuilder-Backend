      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert in resume writing. Your task is to enhance the professional summary of a resume. The summary should be only 1-2 sentences also highlighting key skills, experience, amd career objectives. Make it compelling and ATS-friendly, and only return text no option or anything else",
        },
        {
          role: "user",
          content: userContent,
...
export const uploadResume = async (req, res) => {
  try {
    ...
    const systemPrompt = "You an expert AI Agent to extract data from resume";
